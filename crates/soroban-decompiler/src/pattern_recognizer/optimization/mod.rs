...
//! i128 arithmetic collapse, constant guard folding, identity binding
//! elimination, and scoped binding hoisting.
...
pub use guards::fold_constant_guards;
pub use hoisting::hoist_scoped_bindings;
pub use i128::collapse_i128_patterns;
pub use identity::eliminate_identity_bindings;
...
/// Collect variable names from an expression into a set.
